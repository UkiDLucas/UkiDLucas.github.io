---
collection_name: AI
slug: aiko-the-tiny-language-model-tlm
published: 2025-03-22
last_updated: 2025-03-22
redirect_from:
  - /posts/aiko-the-tiny-language-model-tlm
  - /posts/aiko-the-tiny-language-model-tlm/
layout: paper
...
Why is a 2,000-word vocabulary just enough?
...
You can run the file in Visual Studio Code to see if there are no errors in the LLM architecture definition.

Code notes

`nn.Sequential` is a convenient wrapper provided by MLX that chains multiple neural network layers together. It takes the layers you pass and connects them one after another, simplifying the forward pass. It helps you build clean, readable model architectures without manually calling each layer.
...
The model's output is called "logits," raw predictions which aren't yet probabilities.
...
{"question": "What is the optimal token size?",
...
Why use artificial training data with a joke?
