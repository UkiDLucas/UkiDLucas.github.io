...
# ╔═╡ 54bccd24-6e59-4960-8ee4-827e472f57db
begin
	using Plots
	using PlutoUI
end

# ╔═╡ cd1484f2-fd5b-11ec-3067-bd56340e1604
begin # define known variables
	building = 828 # units: m -- Burj Khalifa building
	moon = 391000000 # units: m; distance to the moon
	sheet = 0.1 / 1000  # unit: m -- thickness of 1 sheet of paper;100 sheets per 1 cm
	nothing # show nothing
end

# ╔═╡ 7939b54e-d610-4a18-a58e-65cb628115ba
...
# ╔═╡ a3356367-92e4-44d3-accb-d9c49a218ec6
begin 
...
# ╔═╡ 692c6a6e-5bf4-41fd-86cd-d836b17d4fd2
@bind slider_ui Slider(1:increments) # one widget per cell

# ╔═╡ 79cf40c5-d44b-426e-99cd-68c3aa75c725
@bind plot_type Select(["scatter","line","bar"])

# ╔═╡ 44159a27-f52f-46b9-970a-260ded78ca11
plot(
	data[1:slider_ui], 
...
# ╔═╡ 7fffd053-f7a5-461f-abe5-963e76d8ea36
md"""
## References
- [Pluto.jl for science intro](https://www.juliafordatascience.com/first-steps-5-pluto/)
- [plots tutorial](https://docs.juliaplots.org/latest/gallery/gr/)
- [arrays tutorial](https://docs.julialang.org/en/v1/base/arrays/)
- [markdown tutorial](https://docs.julialang.org/en/v1/stdlib/Markdown/)
- [function tutorial](https://docs.julialang.org/en/v1/manual/functions/)
"""
