---
collection_name: AI
slug: ai-zen-garden-multi-agent-llm-collegium
published: 2025-03-08
last_updated: 2025-03-08
redirect_from:
  - /posts/ai-zen-garden-multi-agent-llm-collegium
  - /posts/ai-zen-garden-multi-agent-llm-collegium/
layout: paper
...
Fine-tuning each model to develop its style and focus on a particular subject is what turns a generic large language model (LLM) into Darwin AI, Plato AI, Socrates AI, My Personal Assistant AI, My Ghostwriter AI, and, at work, my Code expert AI, my Systems Engineering AI, my Requirements AI, and so on.
...
The context window of the LLM AI is like a short-term memory. It is a collection of things this particular LLM should remember when performing the task. It is more than a "Google search question" or a short ChatGPT prompt. Today's LLM context window is 132,000-word tokens or a medium-sized book, slightly less than Dune or War and Peace. That is a lot of information about your or your business needs!

The long-term memory for LLM is a collection of thousands of your Obsidian notes, blog posts, articles, and scientific papers. It is usually provided as a Retrieval-Augmented Generation (RAG) system.
