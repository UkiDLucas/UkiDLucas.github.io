...
In this post, I proudly present a new [AIKOassistant.ai](http://aikoassistant.ai/) native macOS app.  
...
[AIKOassistant.ai](http://aikoassistant.ai/) is my answer to that.
